...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-2xl bg-white/90 backdrop-blur-sm border border-gray-200/60 shadow-sm',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      'text-base sm:text-lg font-semibold leading-none tracking-tight text-gray-900',
      className
    )}
    {...props}
  />
