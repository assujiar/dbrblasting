...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-xl bg-neutral-100/50 p-1 text-neutral-500',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'data-[state=active]:bg-white/80 data-[state=active]:text-neutral-900 data-[state=active]:shadow-sm',
      className
    )}
    {...props}
  />
